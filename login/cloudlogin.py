...
def loginPre(page):  # 预发环境
    ...
    page.locator("[placeholder=\"请输入密码\"]").fill(cryptocode.decrypt(cloudUser["pre"][1],key))
...
def loginPrd(page):  # 生产环境
    ...
    page.locator("[placeholder=\"请输入密码\"]").fill(cryptocode.decrypt(cloudUser["prd"][1],key))
    with page.expect_navigation():
        page.locator("text=登 录").click()
...
def loginTest(page):  # 测试环境
    ...
    page.locator("[placeholder=\"密码\"]").fill(cryptocode.decrypt(cloudUser["test"][1],key))
    with page.expect_navigation():
...
def loginGfPrd(page):  # 公服生产
    ...
    page.locator("[placeholder=\"请输入密码\"]").fill(cryptocode.decrypt(cloudUser["gfprd"][1],key))
    with page.expect_navigation():
        page.locator("text=登 录").click()
...
def loginGfPre(page):  # 公服预发
    ...
    page.locator("[placeholder=\"请输入密码\"]").fill(cryptocode.decrypt(cloudUser["pgfpre"][1],key))
    with page.expect_navigation():
        page.locator("text=登 录").click()
